...
export default function HeroSection({ title, subtitle }: HeroSectionProps) {
  ...
  return (
    <section
      ...
      className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden hero-gradient"
    >
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-neutral-100 border border-neutral-200 text-neutral-600 text-xs font-semibold tracking-wide uppercase mb-8"
            >
            ...
            <motion.p
              ...
              className="text-neutral-500 mb-10 leading-relaxed max-w-xl text-lg lg:text-xl"
            >
            ...
            >
              <a
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 bg-secondary text-white rounded-full font-bold text-base hover:bg-secondary-600 hover:shadow-strong hover:-translate-y-0.5 transition-all duration-300"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 text-neutral-600 font-bold text-base hover:text-secondary transition-colors duration-300"
              >
                Entender o processo
          ...
          <div className="lg:col-span-5 relative mt-16 lg:mt-0 flex justify-center lg:justify-end min-h-[400px]">
            <motion.div
            ...
            >
              ...
              <img
                ...
                alt=""
                className="w-full h-auto min-w-[500px] lg:min-w-[700px] lg:-mr-32 object-contain opacity-75"
                aria-hidden="true"
              />
            </motion.div>
          </div>
